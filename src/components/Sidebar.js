      ...
      <div className='flex flex-col gap-y-3 py-4 mt-4'>
        <div className='flex w-full justify-between items-center'>
          ...
          <div className='uppercase font-semibold'>
            <span className='mr-5'>Total:</span> USD {parseFloat(total).toFixed(2)}
          </div>
          {/* clear cart icon */}
          <div 
          onClick={clearCart}
          className='cursor-pointer py-4 text-white w-12 h-12 flex justify-center items-center text-xl'>
